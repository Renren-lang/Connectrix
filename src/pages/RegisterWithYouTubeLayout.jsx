...
function RegisterWithYouTubeLayout() {
  ...
  return (
    <YouTubeLayout currentPage="Register">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div className="form-group">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    >
                      <span className="material-icons text-xl mb-2 block">school</span>
                    ...
                    >
                      <span className="material-icons text-xl mb-2 block">work</span>
                    ...
                    <div className="form-group">
                      <label className="flex items-center cursor-pointer">
                        <input
                          ...
                          onChange={handleInputChange}
                          className="ml-0 mr-3 w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
...
export default RegisterWithYouTubeLayout;
